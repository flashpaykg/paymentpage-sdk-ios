...
//
//  Copyright © 2019 Flashpay. All rights reserved.
//
...
@property (nonatomic, strong) FlashpaySDK *flashpaySDK;
@end
...
- (void)viewDidLoad {
    ...
    // Init SDK
    self.flashpaySDK = [[FlashpaySDK alloc] init];
...
//    theme.showDarkKeyboard = true;
    [self.flashpaySDK setTheme:theme];
}
...
{
    NSNumber *code = [[error userInfo] objectForKey:FlashpaySDK.kSDKInitErrorCodeKey];
    if (code != nil) {
